...
const Letter = ({ letterPos, attemptValue }) => {
  ...
  return (
    <div
      className={`text-white cursor-none hover:scale-105 flex transition-colors ease-in 1s items-center justify-center text-2xl lg:text-[40px] w-[40px] h-[40px] lg:w-[70px] lg:h-[70px] my-2 border-[1px] rounded-sm lg:rounded-md border-black
